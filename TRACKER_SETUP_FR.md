...
- un champ `payload` lisible en bullets avec seulement les infos utiles:
  action, element travaille, bonnes reponses, score, nombre pratique, nombre a
  revoir, langue et session courte.
